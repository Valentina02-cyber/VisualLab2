	...
	{ 
		static void Main(string[] args)
		{
			try
			{
                ...
                Console.WriteLine($"Сложение: {r1.ToString()} + {r3.ToString()} = {(r1 + r3).ToString()}");
                Console.WriteLine($"Вычитание: {r4.ToString()} - {r5.ToString()} = {(r4 - r5).ToString()}");
                Console.WriteLine($"Умножение: {r2.ToString()} * {r4.ToString()} = {(r2 * r4).ToString()}");
                Console.WriteLine($"Деление: {r2.ToString()} / {r5.ToString()} = {(r2 / r5).ToString()}");
